The following list shows wallets that are compatible with the AirGap. You can import your 24 words in the following wallets to get the same accounts that you have in AirGap.
