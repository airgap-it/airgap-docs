...
- The "Password" can optionally be set when adding a Secret. This will allow you to set an additional password that is required every time the Vault accesses your Secret in order to generate accounts or sign transactions. This password will w**NOT** allo you to recover your funds in case you lose your 24 word backup.
