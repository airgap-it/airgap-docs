...
Yes, but the unlisted ones will not be visible in the AirGap Wallet. But you can connect to any ethereum DApp using the walleconnect functionality to interact with the token.
