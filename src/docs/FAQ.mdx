...
Currently, AirGap is available in English, German (AI translated), Chinese (AI translated), Spanish (AI translated), Portuguese, Russian, and French (AI translated) . We are planning to add more languages. If you could help us translate our apps, please reach out to us!
