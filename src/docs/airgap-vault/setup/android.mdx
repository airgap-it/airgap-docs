---
title: How To Set Up Secure A Cold Wallet With AirGap Vault (Android)
...
- Copy the downloaded file from your online computer to the offline device via SD Card or USB Stick and replace the old installation.
