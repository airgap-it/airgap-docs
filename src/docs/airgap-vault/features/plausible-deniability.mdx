...
- The passphrase acts as a layer of security in case of an attack. For instance, if your 24-word secret recovery phrase were to be compromised. The attacker has to access both the secret recovery phrase phrase and the passphrase in order to steal your funds.
