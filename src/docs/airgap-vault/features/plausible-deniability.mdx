...
It works by adding a passphrase when creating an account. This can be useful to protect you if you are threatened and compelled to provide your mnemonic, or simply as an additional security measure in case you expose your mnemonic by accident.
...
- The passphrase acts as a layer of security in case of an attack. For instance, if your 24-word seed phrase were to be compromised. The attacker has to access both the seed phrase and the passphrase in order to steal your funds.
