...
AirGap Wallet provides safe, straightforward interaction with Tezos based NFTs by indexing objkt API.

#### Access numerous DApps.
You can access the most popular DApps with AirGap using our WalletConnect feature for ETH and Beacon for Tezos.
