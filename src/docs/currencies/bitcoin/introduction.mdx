...
This format was introduced to solve the compatibility issue between Legacy and Segwit addresses. We currently do not support this format, but we may consider looking into it in the future.
