...
- #### Taproot - [Coming soon]
This format comes with the latest bitcoin update, it is a soft fork that improves Bitcoin’s scripts to increase privacy, efficiency, and the network’s ability to process smart contracts. Start with "bc1p", example bc1p60vkdsn37kk9xgm5vw0jasrxw8lsrx68rqwr2g.
