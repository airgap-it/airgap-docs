...
slug: /currencies/aeternity/introduction
sidebar_label: Introduction
---

## introduction

Aeternity.com is a blockchain 3.0 smart contracts platform built for scale & user-friendliness. It features a Bitcoin-NG consensus mechanism, Cuckoo Cycle PoW, Layer 1 integrated off-chain state channels, a naming system, oracles & functional smart contracts. AE is the native currency of Aeternity.
