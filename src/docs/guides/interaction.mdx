...
If you have disabled all your device connections, the app will automatically choose the "QR code scanning" mode. However, if you have an online device, you will see these three modes of interaction:
