---
title: Setup MetaMask mobile with AirGap
...
If you interested in setting up MetaMask extension please visit [here](/guides/metamask)
:::
...
<IPhoneWrapper src={'/img/metamask/mm31.png'} />

<IPhoneWrapper src={'/img/metamask/mm32.png'} />

Select Ethereum (ETH) and click the create button. Select the newly created ETH account.

<IPhoneWrapper src={'/img/metamask/mm34.png'} />

<IPhoneWrapper src={'/img/metamask/mm35.png'} />

Click the MetaMask button

<IPhoneWrapper src={'/img/metamask/mm36.png'} />
...
<IPhoneWrapper src={'/img/mmmobile/mm38.jpg'} />
