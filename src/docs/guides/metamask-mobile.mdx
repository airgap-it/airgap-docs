...
<IPhoneWrapper src={"/img/mmmobile/mm31.png"} />

<IPhoneWrapper src={"/img/mmmobile/mm32.png"} />

Select Ethereum (ETH) and click the create button. Select the newly created ETH account.

<IPhoneWrapper src={"/img/mmmobile/mm34.png"} />

<IPhoneWrapper src={"/img/mmmobile/mm35.png"} />

Click the MetaMask button

<IPhoneWrapper src={"/img/mmmobile/mm36.png"} />
