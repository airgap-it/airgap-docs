...
This feature has not been released yet. You can check the progress [here](https://github.com/airgap-it/airgap-vault/issues/112) and download a beta version [here](https://github.com/airgap-it/airgap-vault/releases/tag/v3.13.0-beta.0). **Only use this version for testing purposes!**
:::
...
Confirm your seed phrase in the order shown on the previous page, and then click the "Confirm" button.
