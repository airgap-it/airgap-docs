...
If your secret, meaning your 24 words, is compromised, it is impossible to act quickly.
...
4. If you actively use a blockchain to hold tokens, NFTs or use DeFi, think about the following points. If any apply, try to move the funds out as quickly as possible:
...
- During the setup of AirGap, you were required to create a backup of your secret. Do you still that backup somewhere?
...
- Have you ever shared your secret with a friend that could still have access to it?
