...
<div class="yt-container">
  <iframe
    class="yt-video"
    src="https://www.youtube.com/embed/bHpL186UKGM"
    frameborder="0"
    allowfullscreen
  ></iframe>
</div>
...
The Recovery Plate can hold 12, 15, 18, 21, or 24 words and can be used with all sorts of BIP39/44 Wallet setups such as AirGap, Ledger, Trezor, etc. But we recommend using these plates with the AirGap Wallet / Vault setup since it offers highest security, the best usability, is open-source and for free.
For more information, visit www.airgap.it

On the Front side you will find the main instructions;

- [Where to download AirGap Vault](https://support.airgap.it/guides/step-by-step-guide#step-by-step-guide-for-setting-up-airgap)
- [How to create a new Seedphrase](https://support.airgap.it/guides/step-by-step-guide#step-by-step-guide-for-setting-up-airgap)
- [How to import your Seedphrase](https://support.airgap.it/guides/import-recovery-phrase)
...
If the second plate is used as a cover the users should make sure that the recovery-seed side is facing inwards. They can then secure the plates by using the temper stickers. Optionally, users can secure the plates with screws or cable ties by utilising the holes on the bottom and the top.
